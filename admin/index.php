                ...
                <div class="mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h2 class="card-title" style="color: #0483c4;">Bienvenue Professeur
                          <?php  echo $info_utilisateur['nom'] ?>🎉</h2>
                          <p class="mb-4">
                            N'hésitez pas à <span class="fw-bold">configurer</span> votre emploi du temps selon votre disponiblité
                          </p>
